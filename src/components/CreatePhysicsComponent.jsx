...
class CreatePhysicsComponent extends Component {
    constructor(props) {
        ...
        this.saveOrUpdatePhysics = this.saveOrUpdatePhysics.bind(this);
    }
    ...
    getTitle(){
        if(this.state.id === '_add'){
            return <h3 className="text-center">Adicionar novo usuario</h3>
        }else{
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <button className="btn btn-success" onClick={this.saveOrUpdatePhysics}>Salvar</button>
...
export default CreatePhysicsComponent;