...
class CreatePackageTravel extends Component {
    ...
    saveOrUpdatePackage = (e) => {
        e.preventDefault();
        let packageTravel = { title: this.state.title, idAddressDestiny: this.state.idAddressDestiny, idAddressOrigin: this.state.idAddressOrigin,  people: this.state.people , value: this.state.value, dateGoing: this.state.dateGoing, dateReturn: this.state.dateReturn, legal: this.state.legal};
    ...
    getTitle() {
        if (this.state.id === '_add') {
            return <h3 className="text-center">Adicionar pacote de viagem</h3>
        } else {
            return <h3 className="text-center">Atualizar pacote de viagem</h3>
        }
    }
    render() {
        return (
                        ...
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.saveOrUpdatePackage}>Salvar</button>
...
export default CreatePackageTravel;